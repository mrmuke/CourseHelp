...
export default function CreateGroup() {
    ...
    return <View style={{ padding: 20 }}>
        ...
        <TextInput placeholder="Group name..." onChangeText={() => setName(text)} />
        <TextInput style={{ marginTop: 5 }} placeholder="Group description..." onChangeText={() => setDescription(text)} />
        ...
        {image ? <Button icon="cake" contentStyle={{ padding: 20 }} style={{ marginTop: 10 }} color="#003152" mode="contained">Survive HS Now!</Button> : <Button icon="upload" contentStyle={{ padding: 20 }} style={{ marginTop: 10 }} color="#003152" mode="contained">Upload Image</Button>
        }
    </View>
}